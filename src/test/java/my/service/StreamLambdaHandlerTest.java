...
public class StreamLambdaHandlerTest {
    ...
    @Test
    public void streamRequest_respondsWithWeather() {
        InputStream requestStream = new AwsProxyRequestBuilder("/weather", HttpMethod.GET)
        ...
        assertTrue("Not a numeric response", NumberUtils.isParsable(response.getBody()));
